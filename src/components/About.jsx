...
export const About = () => {
  return (
    <div>
        ...
        <div className="bg-homecolor relative overflow-hidden flex items-center pb-24">
            <motion.div
                initial={{ x: -100 }}
                animate={{ x: 0 }}
            ...
            <div>
                <div className="absolute left-1/2 p-10 bg-white rounded-l-3xl mb-20">
                    ...
                    Nuestra experiencia y profesionalismo nos avalan como una empresa líder en el mercado, ofreciendo soluciones integrales en cada proyecto que emprendemos.
                    
                    </h1>
                    <button className='border py-2 px-2 rounded-xl border-homecolor text-white bg-homecolor transition hover:bg-white hover:text-homecolor'> 
                        Conoce más
                    </button>
                </div>
            </div>
